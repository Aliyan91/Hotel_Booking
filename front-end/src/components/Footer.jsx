            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-14">
                <div className="sm:col-span-2 lg:col-span-1">
                    <a href="https://prebuiltui.com">
                        <img src="/logo.png" alt="LankaStays" />
                    </a>
                ...
                <div className="flex flex-col lg:items-center lg:justify-center">
                    <div className="flex flex-col text-sm space-y-2.5">
                        ...
                        <a className="hover:text-slate-600 transition" href="/hotels">Hotels</a>
                        <a className="hover:text-slate-600 transition" href="/contact">Rooms</a>
                        
                    </div>
                </div>
                
            </div>
            <div className="flex flex-row items-center justify-center py-4 border-t mt-6 border-slate-200">
                <p className="text-center">
                    Copyright 2025 © <a href="/home">LankaStay</a> All Right Reserved.
                </p>
